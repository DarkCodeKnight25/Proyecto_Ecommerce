const productoModel = require("../database/productoModel");

const crearProducto = async(nombre, idproveedor, marca, modelo, color, costo, precio, stock, estado, descripcion, imagen) => {
    let producto = null;
    try {
        producto = await productoModel.crearProducto(nombre, idproveedor, marca, modelo, color, costo, precio, stock, estado, descripcion, imagen );
    } catch (exception) {
...
const actualizarProducto = async(id, nombre, idproveedor, marca, modelo, color, costo, precio, stock, estado, descripcion) => {
    let producto = null;
    try {
        producto = await productoModel.actualizarProducto(id, nombre, idproveedor, marca, modelo, color, costo, precio, stock, estado, descripcion);   
    } catch (exception) {
